        ...
        <div className="max-w-5xl mx-auto">
          ...
          delay: 0.7
            ...
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="font-semibold text-primary text-5xl">SiNa</span>
            </div>
          ...
          {/* Main Content Card */}
          <motion.div className="bg-card border border-border rounded-2xl p-8 lg:p-10 shadow-lg mb-8" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          delay: 1.1
            ...
            return <div key={index} className="flex items-start gap-4 bg-card border border-border rounded-xl p-5 hover:shadow-md transition-shadow">
          ...
          {/* Conclusion */}
          <motion.div className="bg-primary/5 border border-primary/20 rounded-xl p-6 lg:p-8" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
